...
namespace BusInfo
{
    public partial class honor : MetroFramework.Forms.MetroForm
    {
        public int seat;
        ...
        public honor(string date, string depart, string arrive, string time, int fare, string name
            , int IsAdmin)
        {
            InitializeComponent();
            ...
            } else
            {
                ...
                else
                {
                    using (conn = new SqlConnection(constr))
                    {
                        ...
                        cmd1.Parameters.AddWithValue("@등급", "우등");
